                    ...
                    <div class="card-group">
                        <div class="card border-0">
                            <div class="card-body p-2">
                                ...
                                <div class="d-flex">
{{--                                      <input id="selectEducation" class="form-control select-input" data-input="{{ $categories->pluck('title')->implode(',') }}" name='community-category' placeholder="--- Choose community-category ---" />
  --}}
                    ...
                    <div class="card-group">
                        <div class="card border-0">
                            <div class="card-body p-2">
                                ...
                                <div class="d-flex">
                                    <select multiple="true" name="choose_usr_email[]" id="choose_usr_email" class="form-control token-select2 select2">
...
<div class="modal fade" id="categoryModal" tabindex="-1" role="dialog" aria-labelledby="categoryModalTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form id="formCategory" method="POST" action="/admin/community-categories" class="mb-5">
        <div class="modal-content">
            ...
            <div class="modal-body border-0">
                <div class="table-responsive table-community-category overflow-x col-lg-12">
...
<div class="modal fade" id="communitySegmentModal" tabindex="-1" role="dialog" aria-labelledby="communitySegmentModalTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form id="formSegment" method="POST" action="/admin/segments" class="mb-5">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="communityAreaModal" tabindex="-1" role="dialog" aria-labelledby="communityAreaModalTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form id="formArea" method="POST" action="/admin/areas" class="mb-5">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="communityAreaModalLabel"><span style="width:25px;height:25px;" data-feather="info"></span> Segment
            ...
            @csrf
            <div class="modal-body border-0">
                <div class="table-responsive table-community-area overflow-x col-lg-12">
