...
<div class="row my-3">
    <div class="col-lg-12">
        ...
        <h2 class="h2 px-3">Edit Event Template</h2>
    </div>
</div>

<div class="row my-3">
    <form method="POST" action="/admin/event-templates/{{ $eventTemplate->uuid }}" class="mb-5" enctype="multipart/form-data">
        @method('put')
        @csrf
                        ...
                        <div class="card-body p-2">
                            ...
                            <div class="d-flex">
                                <div class="select-offering-accounts col-md-10">
                                    @include('master-data.select-offering-account')
                                </div>
                            </div>
